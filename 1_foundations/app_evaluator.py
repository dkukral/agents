...
The Agent has been provided with context on {self.name} in the form of their summary and LinkedIn details. Here's the information:"
    ...
    def evaluate(self, reply, message, history) -> Evaluation:
      ...
      response = self.gemini.beta.chat.completions.parse(model="gemini-2.0-flash", messages=messages, response_format=self.Evaluation)
    ...
    def chat(self, message, history):
        ...
        while not done:
          ...
          if not evaluation.is_acceptable:
            reply = self.rerun(reply.choices[0].message.content, message, history, evaluation.feedback)
